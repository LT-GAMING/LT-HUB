...
local v22 success, result = pcall(function()
...
if Sea3 then
    ...
    task.spawn(function()
        while task.wait(1) do
            pcall(function()
                ...
                local moonTex = sky.MoonTextureId or ""
    
                if moonTex:find("moon_0") then
                    FullMoonStatus = "0%"
                elseif moonTex:find("moon_15") then
                    FullMoonStatus = "15%"
                elseif moonTex:find("moon_25") then
                    FullMoonStatus = "25%"
                elseif moonTex:find("moon_50") then
                    FullMoonStatus = "50%"
                elseif moonTex:find("moon_75") then
                    FullMoonStatus = "75%"
                elseif moonTex:find("moon_full") then
                    FullMoonStatus = "100%"
                else
                    FullMoonStatus = "Không xác định 🌝"
                end
            end)
        end
    end)
    task.spawn(function()
        while task.wait() do
            pcall(function()
                v532:SetDesc(
                    "Đảo Bí Ẩn: " .. (MirageStatus or "?") ..
                    " | Trăng Tròn: " .. (FullMoonStatus or "Không xác định 😊")
                )
            end)
        end 
    end)    
